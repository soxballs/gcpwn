...
from gcpwn.core.utils.module_helpers import module_data_file, read_lines
from gcpwn.modules.cloudfunctions.utilities.helpers import check_anonymous_external
...
def generate_function_permutations(project, region = None):
    v1_regions = read_lines(module_data_file(__file__, "..", "utilities", "data", "regions_v1.txt"))
    v2_regions = read_lines(module_data_file(__file__, "..", "utilities", "data", "regions_v2.txt"))
    all_regions = set([])
