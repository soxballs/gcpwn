...
from gcpwn.core.utils.module_helpers import module_data_file
    ...
    def run(self):
        try:
            for bucket_name in self.permutation_list:
                ...
                if CloudStorageBucketsResource.check_existence(bucket_name):
                    if self.debug:
                    ...
                    CloudStorageBucketsResource.test_bucket_permissions(
                        self.client,
                        bucket_name,
                        gcpbucketbrute=True,
